...
Output the total viewership for laptop and mobile devices in the format of "laptop\_views" and "mobile\_views".
...
| ----------- | ---- |
| user\_id | integer |
| device\_type | string ('laptop', 'tablet', 'phone') |
| view\_time | timestamp |
